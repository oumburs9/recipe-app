...
const ListCard = ({ data }) => {
  ...
  return (
    <>
      <div className="relative mx-56 max-xl:mx-40 max-lg:mx-24 max-md:mx-20 max-sm:mx-10 mb-3 block rounded-lg bg-[#262626] text-left shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 cursor-pointer">
        <div className="flow-root">
          <div className="flex items-center">
            <div className="flex items-center justify-between w-full py-3 sm:py-4" onClick={handleIsActive}>
